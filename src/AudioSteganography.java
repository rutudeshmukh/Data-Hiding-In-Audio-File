...
extends JFrame {
    ...
    public AudioSteganography() {
        ...
        ImageIcon icon = new ImageIcon("F:/NetBeansProjects/AudioSteganography/srcfevicon.jpg");
    ...
    private void initComponents() {
        ...
        this.wallpaperLabel.setIcon(new ImageIcon("wallaper.jpg"));
        this.wallpaperLabel.setBounds(0, 0, 1370,670);
        this.jdp.add((Component)this.wallpaperLabel, JLayeredPane.DEFAULT_LAYER);
        this.EmbedWizardButton.setFont(new Font("Tahoma", 0, 14));
        this.EmbedWizardButton.setIcon(new ImageIcon("embed.png"));
        ...
        this.ExtractWizardButton.setIcon(new ImageIcon("extract.png"));
  ...
  this.ExtractWizardButton.addActionListener(new ActionListener(){
        ...
        this.jButton1.setIcon(new ImageIcon("exit.png"));
        ...
        this.ActionMenu.setIcon(new ImageIcon("action.png"));
        ...
        this.EmbedMenuItem.setIcon(new ImageIcon("embed.png"));
        ...
        this.ExtractMenuItem.setIcon(new ImageIcon("extract.png"));
        ...
        this.ExitMenuItem.setIcon(new ImageIcon("exit.png"));
        ...
        this.HelpMenu.setIcon(new ImageIcon("help.png"));
        ...
        this.AboutMenuItem.setIcon(new ImageIcon("about.png"));
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jdp).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.EmbedWizardButton, -2, 228, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.ExtractWizardButton, -2, 223, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 331, 32767).addComponent(this.jButton1, -2, 30, -2).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jdp, -1, 408, 32767).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.EmbedWizardButton).addComponent(this.ExtractWizardButton)).addComponent(this.jButton1, -2, 30, -2)).addGap(18, 18, 18)));
        this.pack();
    }
    ...
    private void AboutMenuItemActionPerformed(ActionEvent evt) {
    	JOptionPane.showMessageDialog(this, "Audio Steganography Project", "About", 1);
    }
